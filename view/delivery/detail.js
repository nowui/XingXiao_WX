...
Page({
  ...
  handleFind: function (delivery_id) {
    http.request({
      ...
      success: function (data) {
        ...
        for (var i = 0; i < china.children.length; i++) {
          if (china.children[i].id == data.delivery_province) {
            province_index = i;
        ...
        for (var i = 0; i < china.children[province_index].children.length; i++) {
          if (china.children[province_index].children[i].id == data.delivery_city) {
            city_index = i;
        ...
        for (var i = 0; i < china.children[province_index].children[city_index].children.length; i++) {
          if (china.children[province_index].children[city_index].children[i].id == data.delivery_area) {
            area_index = i;
  ...
  handleSubmit: function (event) {
    ...
    var delivery_province_id = china.children[province_index].id;
    var delivery_city_id = china.children[province_index].children[city_index].id;
    var delivery_area_id = china.children[province_index].children[city_index].children[area_index].id;

    var delivery_province_name = china.children[province_index].name;
    var delivery_city_name = china.children[province_index].children[city_index].name;
    var delivery_area_name = china.children[province_index].children[city_index].children[area_index].name;
    ...
    http.request({
      ...
      data: {
        ...
        delivery_province: delivery_province_id,
        delivery_city: delivery_city_id,
        delivery_area: delivery_area_id,
        delivery_street: delivery_street,
        delivery_address: delivery_province_name + delivery_city_name + delivery_area_name + delivery_street,
